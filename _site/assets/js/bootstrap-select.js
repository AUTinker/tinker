...
!function($) {
    ...
    Selectpicker.prototype = {
            ...
            this.$element.find('option').each(function() {
                ...
                if (that.options.hideDisabled && ($this.is(':disabled') || $this.parent().is(':disabled'))) {
                    ...
                    if ($this.index() == 0) {
                        ...
                        _liA.push(that.createA(text, attrs));
                    }
        ...
        createA: function(text, attrs) {
            var a = $('<a>', attrs).append(text);
            var i = $('<i>', {'class': 'glyphicon glyphicon-ok icon-ok check-mark'});
            a.append(i);
        ...
        setSelected: function(index, selected) {
            ...
            this.$menu.find('li').eq(index).toggleClass('active', false);
        },
